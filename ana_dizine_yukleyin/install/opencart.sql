...
(NULL, 'config', 'config_description_1', '&lt;p&gt;\r\n	E-Piksel E-Ticaret ve Web Tasarımı&lt;/p&gt;\r\n'),
(NULL, 'config', 'config_template', 'default'),
(NULL, 'config', 'config_meta_description', 'E-Piksel E-Ticaret ve Web Tasarımı'),
(NULL, 'config', 'config_title', 'E-Piksel E-Ticaret ve Web Tasarımı'),
(NULL, 'config', 'config_fax', ''),
(NULL, 'config', 'config_telephone', '123456789'),
(NULL, 'config', 'config_owner', 'E-Piksel E-Ticaret ve Web Tasarımı'),
(NULL, 'config', 'config_address', 'Address 1'),
(NULL, 'config', 'config_email', 'webmaster@yoursite.com'),
(NULL, 'config', 'config_url', 'http://localhost/v1494/'),
(NULL, 'config', 'config_name', 'E-Piksel'),
